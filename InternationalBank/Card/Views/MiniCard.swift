...
final class MiniCard: BaseVIew {
    ...
    func setGradient(type: Cards) {
        ...
        switch type {
        case .standart:
            self.applyGradient(colorArray: [Resources.Gradients.Standart.start, Resources.Gradients.Standart.end], cornerRadius: 8)
            
        case .pro:
            self.applyGradient(colorArray: [Resources.Gradients.Pro.start, Resources.Gradients.Pro.end], cornerRadius: 8)
            
        case .metal:
            self.applyGradient(colorArray: [Resources.Gradients.Metal.start, Resources.Gradients.Metal.end], cornerRadius: 8)
            
        case .custom:
            self.applyGradient(colorArray: [Resources.Gradients.Custom.start, Resources.Gradients.Custom.end], cornerRadius: 8)
